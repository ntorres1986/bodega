  ...
  var Site = function (_Base) {
    ...
    babelHelpers.createClass(Site, [{
      ...
      value: function initialize() {
        babelHelpers.get(Site.prototype.__proto__ || Object.getPrototypeOf(Site.prototype), 'initialize', this).call(this);
      ...
      value: function process() {
        babelHelpers.get(Site.prototype.__proto__ || Object.getPrototypeOf(Site.prototype), 'process', this).call(this);
...
function ocultarMenuBar()
{
  if( typeof(thisMenu) !== 'undefined' )
  {
    $('body').removeClass('site-menubar-fixed');
    type = 'hide';
    thisMenu.menubar.change(type);
    thisMenu.menubarType(type);
  }
}